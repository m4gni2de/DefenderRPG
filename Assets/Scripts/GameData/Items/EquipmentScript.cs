...
public class Equipment
{
    ...
    public void TomeOfTheShield()
    {
        monster.info.HP.AddModifier(new StatModifier(atkPercentBonus, StatModType.PercentMult, this, itemName));
        monster.info.Defense.AddModifier(new StatModifier(precPercentBonus, StatModType.PercentMult, this, itemName));
    }

    public void BurningScimitar()
    {
        if (monster.info.baseAttack1.attack.type == "Fire")
        {
            monster.info.baseAttack1.Power.AddModifier(new StatModifier(atkPowerPercentBonus, StatModType.PercentMult, this, itemName));
        }

        if (monster.info.baseAttack2.attack.type == "Fire")
        {
            monster.info.baseAttack2.Power.AddModifier(new StatModifier(atkPowerPercentBonus, StatModType.PercentMult, this, itemName));
        }
    }
